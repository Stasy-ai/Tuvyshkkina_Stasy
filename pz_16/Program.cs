...
namespace ConsoleApp8
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Последние действия: " + text);
        ...
        static void WinORLose()
        {
            ...
            {
                Console.Clear();
                PrintCenteredText("Вы проиграли.В следущий раз постарайтесь ", CenterY + 3);
        ...
        {
            PrintCenteredText("Игра сохранена.", CenterY + 3);
        ...
        static void StartGame()
        {
            ...
            PrintCenteredText("Начать игру", CenterY + 10);
            ...
            static void Move()
            {
                ...
                while (true)
                {
                    ...
                    Console.SetCursorPosition(playerY, playerX);
                    Console.Write('P');
                    Console.ForegroundColor = ConsoleColor.DarkGray; // Путь за игроком
                    Console.SetCursorPosition(0, mapSize);


                    Console.SetCursorPosition(0, 25);
                    Console.WriteLine($"Здоровье: {playerhealt} , Силища: {playerbuff} , Шаговии: {newcount} ");
